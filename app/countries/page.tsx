...
import { SectorNetwork } from "@/components/charts/sector-network";
import { StrictnessRank } from "@/components/charts/strictness-rank";
import { Globe2, Network, BarChart3, Grid3x3 } from "lucide-react";
...
export default async function CountriesPage() {
  const [list, ismCountries, meta] = await Promise.all([
    getCountryList(),
    getISMCountries(),
    getISMMeta(),
  ]);
    ...
    <div className="space-y-12">
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          <SectorNetwork countries={ismCountries} groups={meta.sectorGroups} />
        </div>
      </section>
